        ...
        5: [ function(_dereq_, module, exports) {
            ...
            exports.simpleEditor = Class(Editor, {
                init: function() {
                    ...
                    //Commenting since not yet implemented
                }
            });
        }, {
            "../vendor/rangy/core": 11,
...
// Above whole code is from https://github.com/olivier-m/minislate/ the lightweight JS text editor

// onward code is just applying it on window load

var element = document.querySelector('.editable');
var editor = new Minislate.simpleEditor(element);
...
document.addEventListener("keyup",(event)=>{
    ...
    window.localStorage.setItem('tslPapier',document.querySelector('.editable').innerHTML);
